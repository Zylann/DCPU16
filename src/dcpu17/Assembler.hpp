#ifndef HEADER_DCPUASSEMBLER_HPP_INCLUDED
#define HEADER_DCPUASSEMBLER_HPP_INCLUDED
...
private :
	...
	// Returns false if read unexpected stuff, true if it's fine
...
#endif // HEADER_DCPUASSEMBLER_HPP_INCLUDED
