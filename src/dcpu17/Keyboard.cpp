...
namespace dcpu
{
    ...
    void Keyboard::onEvent(const sf::Event & e)
    {
            ...
            e.Type == sf::Event::KeyReleased*/)
        {
            ...
            switch(e.Key.Code)
            {
            case sf::Key::Back:     k = KB_BACKSPACE; break;
            case sf::Key::Return:   k = KB_RETURN; break;
            case sf::Key::Insert:   k = KB_INSERT; break;
            case sf::Key::Delete:   k = KB_DELETE; break;
            case sf::Key::Up:       k = KB_UP; break;
            case sf::Key::Down:     k = KB_DOWN; break;
            case sf::Key::Left:     k = KB_LEFT; break;
            case sf::Key::Right:    k = KB_RIGHT; break;
            case sf::Key::LShift:   k = KB_SHIFT; break;
            case sf::Key::RShift:   k = KB_SHIFT; break;
            case sf::Key::LControl: k = KB_CONTROL; break;
            case sf::Key::RControl: k = KB_CONTROL; break;
            default: break;
            }
    ...
    #define IKD(__key) r_input->IsKeyDown(sf::Key::__key)
    ...
    bool Keyboard::isKeyPressed(u16 k)
    {
        ...
        switch(k)
        {
        case KB_BACKSPACE:  res = IKD(Back); break;
