#ifndef DCPU11DCPUASSEMBLER_HPP_INCLUDED
#define DCPU11DCPUASSEMBLER_HPP_INCLUDED
...
namespace dcpu11
{
    ...
    */
    ...
    private :
        ...
        bool getOperandCode(const Operand & op, u16 & code);
        ...
        bool assembleBasicOp(u16 opcode, Operand a, Operand b);
...
#endif // DCPU11DCPUASSEMBLER_HPP_INCLUDED
